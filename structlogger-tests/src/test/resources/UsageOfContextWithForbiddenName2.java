...
public class UsageOfContextWithForbiddenName2 {

    @LoggerContext(context = ContextWithForbiddenName2.class)
    private static StructLogger<ContextWithForbiddenName2> defaultLog = new StructLogger<>(
